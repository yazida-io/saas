<footer class="pt-7 bg-primary-text text-primary-light">
    <div class="container flex-center flex-col gap-4">
        <x-logo />

        <div class="flex-center gap-4">
            @foreach($links as $link)
                <a href="{{ route($link['route'] ?? 'home') }}" class="px-4 py-2 hover:text-primary">
                    {{ $link['name'] }}
                </a>
            @endforeach
        </div>
        ...
        <div class="w-full">
            <hr class="border-secondary-text" />
        </div>

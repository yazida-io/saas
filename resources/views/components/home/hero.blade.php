<section class="pt-10">
    <div class="container flex h-full items-stretch justify-center pt-20 gap-x-7">
        <div class="w-20 flex justify-center items-start">
            <div class="relative h-96  bg-slate-400/10 rounded-xl w-1 overflow-hidden">
                <span
                    style="height:{{ 1/count($steps) * 100 }}%"
                    class="absolute top-0 w-1 bg-slate-400 rounded-xl"
                ></span>
            </div>
        </div>
        ...
        <div class="flex-1 flex flex-col justify-between items-start gap-y-40">
            ...
            <div class="w-full bg-slate-400/20 flex items-stretch gap-1">
                        ...
                        <div class="relative flex items-stretch justify-start flex-col gap-y-7">
                            ...
                            <p
                                class="px-4 text-lg font-bold
                                    @if($loop->first) text-white @endif text-opacity-70
                                    "
                            >
                                {{ $loop->index + 1  }}
                            </p>
                            ...
                            <div class="px-4">
                                <p class="text-lg text-slate-200 font-bold">{{ $step['title'] }}</p>

...
@section("content")
    ...
    <section class="py-7 space-y-7">
        ...
        <div id="payment-form" class="container py-7 dark:bg-black space-y-7">

            <h3 class="text-2xl font-bold uppercase text-indigo-800 px-7">
                Subscription plan
            </h3>
            ...
            <div class="px-7 py-4 bg-slate-800/20">
